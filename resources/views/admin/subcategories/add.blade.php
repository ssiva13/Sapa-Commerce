...
<div class="row justify-content-between align-items-center mb-10">
    ...
    <div class="col-12 col-lg-auto mb-20">
        <div class="page-heading">
            <h3>Add Subcategory<span>/ Subcategories</span></h3>
        </div>
...
<div class="row mbn-30">
    ...
    <div class="col-lg-12 col-12 mb-30">
        <div class="box">
            ...
            <div class="box-body">
                <form id="add_cat" method="POST" action="{{url('/admin/subcategories')}}" enctype="multipart/form-data">
                    ...
                    <div class="row mbn-20">
                        <div class="col-lg-12 col-md-12 col-sm-12 mb-20">
                            <div class="row">
                                ...
                                <div class="col-12 mb-15">
                                    ...
                                    <select name="category_id" id="formLayoutCat" class="form-control select2">
                        ...
                        <div style="text-align:center;" class="col-12 mb-20">
                            <button id="add_btn" type="submit" class="button button-primary">Add Subcategory</button>
                        </div>
