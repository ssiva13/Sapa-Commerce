...
<form action="{{ route('users.search') }}" method="post">
    @csrf
    <input type="text" name="my_query" class="form-control" placeholder="Search... Users: Name, phone or email">
    <input type="text" name="user_type" style="display: none" value="User">
     ...
     <div class="row justify-content-between align-items-center mb-10">
      ...
      <div class="col-12 col-lg-auto mb-20">
          <div class="page-heading">
              <h3>Fill User Details <span>Fields with asterik(*) are madatory | Note that Password defaults to
  ...
  <div class="row mbn-30">
      ...
      <div class="col-lg-12 col-12 mb-30">
          <div class="box">
              ...
              <div class="box-body">
                <form action="{{ route('users.store') }}" id="demo-form2" data-parsley-validate
