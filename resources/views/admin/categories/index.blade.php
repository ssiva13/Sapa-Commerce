...
<div class="row justify-content-between align-items-center mb-10">
    ...
    <div class="col-12 col-lg-auto mb-20">
        <div class="page-heading">
            <h3 class="title">category<span>| List of all categories</span></h3>
        </div>
...
<div class="col-12 mb-30">
    <div class="box">
        <div class="box-head">
            <h4 class="title">categories Details </h4>
        </div>
        <div class="box-body">
                ...
                <table class="table table-vertical-middle table-selectable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Small modal -->
                                <a data-toggle="modal" data-target=".mod{{ $category->id }}"><span
                                        class="badge badge-danger">Delete</span></a>

                                <div class="modal modal-center fade bs-example-modal-sm mod{{ $category->id }}" tabindex=""
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            {!! Form::open(['action' => ['CategoryController@destroy', $category->id],
                                            'method' => 'DELETE']) !!}
                                            @csrf
                            ...
                            <td>
                                <!-- Small modal -->
                                <a data-toggle="modal" data-target=".mod2{{ $category->id }}"><span
                                    class="badge badge-primary"><i class="fa fa-edit"></i> Edit</span></a>

                                <div class="modal fade bs-example-modal-sm mod2{{ $category->id }}" tabindex="-1"
                                    role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-xs btn-default"
                                                    data-dismiss="modal">Cancel</button>
                                                <button class="btn btn-xs btn-primary" type="submit">update category</button>
                                            </form>
                                            </div>
                                            </form>
                                        </div>
