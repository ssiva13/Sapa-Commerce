...
@section('content')
<main class="main">
    <div class="banner banner-cat" style="background-image: url('/client/assets/images/banner-top.jpg');">
        <div class="banner-content container">
            @if (isset($message))
            <h2 class="banner-subtitle">Search results: {{ $message }} | <small>{{ $cat }}</small></h2>
            @else
                    ...
                    <div class="widget">
                        <h3 class="widget-title">
                            <a data-toggle="collapse" href="#widget-body-y" role="button" aria-expanded="true"
                                aria-controls="widget-body-y">BRANDS</a>
                        </h3>
