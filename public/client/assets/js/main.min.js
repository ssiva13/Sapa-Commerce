$(document).ready(function() {
    if (screen.width<992){
        $('.sidebar-shop #widget-body-1').removeClass('show');
        $('.sidebar-shop #widget-body-2').removeClass('show');
    }
});
!(function(e) {
    "use strict";
    var o = {
        ...
        stickyHeader: function() {
            if (e(".sticky-header").length) {
                ...
                if (!e(".header-bottom").find(".logo, .cart-dropdown").length) {
                    ...
                    e(".header")
                        .find(".logo") //.find(".logo, .cart-dropdown") => replaced for static issues
                        .clone(!0)
                        .prependTo(o);
                }
            }
        ...
        mMenuIcons: function() {
            e(".mobile-menu")
                ...
                .each(function() {
                    var o = e(this);
                    o.find("ul").length &&
                        e("<span/>", { class: "mmenu-btn" }).appendTo(
                            o.children("a")
                        );
                });
        },
        ...
        owlCarousels: function() {
            ...
            t.owlCarousel(
                ...
                e(".entry-slider").each(function() {
                    e(this).owlCarousel(
                        e.extend(!0, {}, o, { margin: 2, lazyLoad: !0 })
                    );
                }),
                ...
                e(".boxed-slider").owlCarousel(
                    e.extend(!0, {}, o, { lazyLoad: !0, autoplayTimeout: 5000 })
                ),
                e(".boxed-slider").on("loaded.owl.lazy", function(o) {
                    e(o.element)
                        .closest(".boxed-slider")
                        .addClass("loaded");
                }),
                e(
        ...
        popover: function() {
            e.fn.popover &&
                e('[data-toggle="popover"]').popover({ trigger: "focus" });
        },
        ...
        scrollToTop: function() {
            e("#scroll-top").on("click", function(o) {
                e("html, body").animate({ scrollTop: 0 }, 1200),
                    o.preventDefault();
            });
        },
        lightBox: function() {
